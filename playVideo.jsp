...
<div id="wrapper"> 
	...
	%>
		<video  width="500" height="250" controls  >
			...
			<embed width="320" height="240" src="data/<%=video.getVideoName()%>.swf">
			</object>
		</video>
		<br/><br/>
		<h2><%=video.getVideoName()%></h2>
		<a href="user_uploader.jsp?userid=<%=user.getId()%>">
	...
	<h1>Comment Here:</h1>
	<form>
	<textarea  multiple="multiple" rows="7" cols="100" style=" font:Arial, Helvetica, sans-serif; font-size:16px; font-size-adjust:inherit; width:400px; height:50pt" type="text" name="commentBox"></textarea>
	<br/>
	
	<input value="submit" type="button" name="submit" onclick="ajaxFunction(commentBox.value,<%=vId%>,<%=userDetail.getId()%>)"/>
					</form></div>
