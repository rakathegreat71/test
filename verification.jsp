...
<div id="wrapper"> 
	...
	<div id="page">
		...
		<h1>enter Your verification Code sent at your email Address:</h1>
		<br/><br/><br/>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
		<input style=" font:Arial, Helvetica, sans-serif; font-size:16pt; font-size-adjust:inherit; width:300px; height:30pt" placeholder="Verification Code"type="text" name="userCode"/>
		
		<br/><br/><br/>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
		<input style=" font:Arial, Helvetica, sans-serif; font-size:16pt; font-size-adjust:inherit; width:300px; height:30pt" type="submit" name="action" value="verify" />
	</form></div>
