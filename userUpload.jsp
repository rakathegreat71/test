...
<div id="wrapper"> 
	...
	<div id="page">
		...
		<form action="form" method="post"  enctype="multipart/form-data" onsubmit="this.elements['submit'].disabled=true;" >&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
		<label style=" font:Arial, Helvetica, sans-serif; font-size:40pt; font-size-adjust:inherit; width:200px; height:150px">Upload Videos</label>
		...
		<br/><br/><br/>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
		<input style=" font:Arial, Helvetica, sans-serif; font-size:16pt; font-size-adjust:inherit; width:300px; height:30pt" type="text" id="fileName" placeholder="FileName" name="photoname" onclick="displayDate()" onchange="displayDate()"/>
		<br/><br/><br/>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
		
		<input style=" font:Arial, Helvetica, sans-serif; font-size:16pt; font-size-adjust:inherit; width:300px; height:30pt" type="text"  placeholder="Title" name="title" required"/>
		<br/><br/><br/>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
		<input style=" font:Arial, Helvetica, sans-serif; font-size:16pt; font-size-adjust:inherit; width:300px; height:30pt" name="submit" type="submit" value="Upload File"/>
    </form>
