	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				...
				<div id="content">
				  <div class="post">
						<form action="controller?action=login" method="post" id="logo1">
						<label style=" font:Arial, Helvetica, sans-serif; font-size:40pt; font-size-adjust:inherit; width:200px; height:150px">you have to login to upload the video:</label>
						&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
						
						<br/><br/><br/><br/><br/><br/>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
        <input style=" font:Arial, Helvetica, sans-serif; font-size:16pt; font-size-adjust:inherit; width:300px; height:30pt" type="text" name="userName"  placeholder="UserName"/>
		<br/><br/><br/>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
		
		<input style=" font:Arial, Helvetica, sans-serif; font-size:16pt; font-size-adjust:inherit; width:300px; height:30pt" type="password" name="password"  placeholder="Password"/>
       <br/><br/><br/>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp

	   <input type="submit" value="login" style="font:Arial, Helvetica, sans-serif; font-size:16pt;height:35pt;width:300px"/>
