			...
			<div id="page-bgbtm">
				...
				<div id="content">
				  <div class="post">
						...
						<label style=" font:Arial, Helvetica, sans-serif; font-size:40pt; font-size-adjust:inherit; width:200px; height:150px">Login</label>
						<br/><br/><br/><br/><br/><br/>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
        <input style=" font:Arial, Helvetica, sans-serif; font-size:16pt; font-size-adjust:inherit; width:300px; height:30pt" type="email" name="userName"  required placeholder="UserName"/>
		<br/><br/><br/>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
		
		<input style=" font:Arial, Helvetica, sans-serif; font-size:16pt; font-size-adjust:inherit; width:300px; height:30pt" type="password" name="password" required placeholder="Password"/>
       <br/><br/><br/>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
