...
<div id="wrapper"> 
	...
	<%
		...
		<h2><center> Your Uploaded videos:</center><br/><br/><br/></h3>
	...
	%><center>
		<input name="video" width="350px" height="230px" type="image" value="<%=video.getVideoId()%>" src="data/<%=video.getImageName()%>" />
